...
public class Main {
    public static void main(String[] args) {
        int miza = 10;
        JocZaruriStop jucator1 = new JocZaruriStop(20);
        JocZaruriStop jucator2 = new JocZaruriStop(30);
        ...
        if (raspuns.equalsIgnoreCase("da")) {
            do {
                ...
                switch (JocZaruriStop.comparareZaruri(jucator1, jucator2)) {
                    case -1:
            ...
            } while (raspuns.equalsIgnoreCase("da") && jucator1.getSumaJucator()>=miza
                    && jucator2.getSumaJucator()>=miza);
